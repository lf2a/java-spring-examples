...
import com.lf2a.afterthrowing.Account;
...
public class MyDemoLoggingAspect {
    ...
    @AfterThrowing(pointcut = "execution(* com.lf2a.afterthrowing.dao.AccountDAO.findAccounts(..))", throwing = "theExec")
    ...
    @AfterReturning(pointcut = "execution(* com.lf2a.afterthrowing.dao.AccountDAO.findAccounts(..))", returning = "result")
...
//        System.out.println("\n====>>> result is: " + result);
    ...
    @Before("com.lf2a.afterthrowing.aspect.AopExpressions.forDaoPackageNoGetterSetter()")
